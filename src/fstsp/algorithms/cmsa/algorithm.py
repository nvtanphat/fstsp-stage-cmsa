        ...
        history.append(
            {
                ...
                "original_variables": mip_sol.metadata.get("original_variables") or mip_sol.metadata.get("n_variables"),
                "original_constraints": mip_sol.metadata.get("original_constraints") or mip_sol.metadata.get("n_constraints"),
                "original_nonzeros": mip_sol.metadata.get("original_nonzeros") or mip_sol.metadata.get("n_nonzeros"),
                "free_variables": mip_sol.metadata.get("free_variables") or mip_sol.metadata.get("n_free_variables"),
                "fixed_zero_variables": mip_sol.metadata.get("fixed_zero_variables") or mip_sol.metadata.get("n_fixed_zero_variables"),
                "fixed_one_variables": mip_sol.metadata.get("fixed_one_variables") or mip_sol.metadata.get("n_fixed_one_variables"),
                "active_constraints_before_presolve": mip_sol.metadata.get("active_constraints_before_presolve") or mip_sol.metadata.get("n_active_constraints"),
                "active_nonzeros_before_presolve": mip_sol.metadata.get("active_nonzeros_before_presolve") or mip_sol.metadata.get("n_active_nonzeros"),
    ...
    best.metadata.update(
        {
            ...
            "seed": seed,
            "solver_backend": solver_backend,
            "construction_tsp_backend": solver_backend,
